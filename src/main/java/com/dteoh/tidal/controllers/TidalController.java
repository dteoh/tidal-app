...
import com.dteoh.tidal.views.AccountsDialog;
...
import com.dteoh.tidal.views.swing.TiledImagePanel;
...
public class TidalController implements AccessViewListener, MenuBarViewListener {
     ...
     * 
     * @see com.dteoh.tidal.views.events.MenuBarViewListener#menuButtonClicked
     *      (com.dteoh.tidal.views.events.MenuBarViewEvent)
     */
    @Override
